class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.titleText = this.add.text(gameConfig.width / 2 - 150, gameConfig.height / 2 - 300 , "Ganhou o Jogador: ", {
            font: "50px Arial",
            fill: "#ffff44",
            align: "center"
        });
        ...
        this.button1 = this.add.image(gameConfig.width / 2 + 150, gameConfig.height / 2 + 50, 'instructionsButton').setScale(0.5).setInteractive({ useHandCursor: true });
        this.button2 = this.add.image(gameConfig.width / 2 - 150, gameConfig.height / 2 + 50, 'playButton').setScale(0.5).setInteractive({ useHandCursor: true });
